...
namespace libReport
{
    ...
    public class BaoCaoBanHang_TongHopPRC
    {
        ...
        public double? TongGiamTruBaoHiem { get; set; }
    ...
    public class BaoCaoDoanhThuSuaChuaTongHop
    {
        ...
        public double TongChiPhi { get; set; }
        public double TongGiamGia { get; set; }
        public double TongGiamTruBH { get; set; }
        public double DoanhThu { get; set; }
        public double TienVon { get; set; }
        ...
        public double SGiamTruBH { get; set; }
    ...
    public class BaoCaoDoanhThuSuaChuaChiTiet
    {
        ...
        public double GiamTruBH { get; set; }
        public double DoanhThu { get; set; }
        public double TienVon { get; set; }
        public double LoiNhuan { get; set; }
        public string GhiChu { get; set; }
    ...
    public class BaoCaoDoanhThuSuaChuaTheoXe
    {
        ...
        public double STongGiamTruBH { get; set; }
    ...
    public class GetListPhuTungTheoDoi_v1_Input
    {
        public string TextSearch { get; set; }
    ...
    public class GetListPhuTungTheoDoi_v1_Result
    {
        public Guid Id { get; set; }
        public Guid IdHoaDon { get; set; }
    ...
    public class GetThoiGianHoatDong_v1_Input
    {
        public string TextSearch { get; set; } = "";
        public DateTime? ThoiGianFrom { get; set; }
        public DateTime ThoiGianTo { get; set; } = DateTime.Now;
        public int CurrentPage { get; set; } = 1;
        public int PageSize { get; set; } = 10;
    }

    public class GetThoiGianHoatDong_v1_Result
    {
        public Guid Id { get; set; }
        public string BienSo { get; set; }
