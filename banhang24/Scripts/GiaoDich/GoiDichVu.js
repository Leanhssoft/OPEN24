var ViewModelHD = function () {
    ...
    async function SearchHoaDon(isGoToNext, isExport) {
        ...
        if (isExport) {
            ...
            exportOK = await commonStatisJs.DowloadFile_fromBrower(BH_HoaDonUri + 'ExportExcel_GoiDichVu', 'POST', param, 'DanhSachGoiDichVu.xlsx');
            if (exportOK) {
    ...
    function CheckExistCacheHD_andRemove(idHoaDon) {
        let hdCacheName = 'lstHDLe', cthdCacheName = 'lstCTHDLe';
        if (self.isGara()) {
